...
source = "/terraform_training/phase_3/terraform_modules/ami_amazon2023"
  #  version = "1.0.0"
}
module "networking" {
source = "/terraform_training/phase_3/terraform_modules/networking"
  #  version = "1.0.0"
...
source = "/terraform_training/phase_3/terraform_modules/security_groups"
  #  version = "1.0.0"
...
module "ec2" {
    source = "/terraform_training/phase_3/terraform_modules/ec2"
  #  version = "1.0.0"
